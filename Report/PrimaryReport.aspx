<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ReportMaster.Master" AutoEventWireup="true" CodeBehind="PrimaryReport.aspx.cs" Inherits="HRISDashboard.Report.PrimaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="container-fluid">
            <div style="clear: both; width: 100%;">
                ...
                <div style="clear: both;">
                    <ul style="margin: 2px; list-style: none; background: #f1f1f1; border: 1px solid #000000; padding: 5px; font-size: 14px; font-weight: 600;">
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTEmployeeType">Employee Type :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                        ...
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTUlbType">ULB Type :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                            <label id="lblUlbType">--</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTUlbName">ULB Name :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                            <label id="lblUlbName">--</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTDesignation">Designation :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                            <label id="lblDesignation">--</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTRetireYear">Retirement Year :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                            <label id="lblRetireYear">--</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTJoinYear">Joining Year :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                            <label id="lblJoinYear">--</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px; font-weight: 600;">
                            <label id="lblTEmployeeName">Employee Name :</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px;">
                            <label id="lblEmployeeName">--</label>
                        </li>
                        <li style="display: inline-block; padding: 2px; font-size: 14px; width: 220px" class="f-right d-print-none">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var RetirementYear = getParameter("RetirementYear");
            var JoiningYear = getParameter("JoiningYear");
            ...
            var EmployeeKey = getParameter("EmployeeKey");
            ...
            if (RetirementYear != "") {
                $('#lblRetireYear').text(RetirementYear);
            }
            else {
                $('#lblTRetireYear').text('');
                 $('#lblRetireYear').text('');
            ...
            if (EmployeeName != "") {
                ...
                $('#lblTEmployeeName').text('');
                $('#lblEmployeeName').text('');
            }

            if (EmployeeKey != "") {
                $('#lblEmployeeKey').text(EmployeeKey);
            }
            else {
                $('#lblTEmployeeKey').text('');
                $('#lblEmployeeKey').text('');
            }
            ...
            $.ajax({
                type: "POST",
                url: "PrimaryReport.aspx/GetEmployeeDetail",
                data: '{RGroup:' + JSON.stringify(GroupType) + ',EmployeeType:' + JSON.stringify(EmployeeType) + ',OfficeType:' + JSON.stringify(OfficeType) + ''+
                        ' , RetirementYear: ' + JSON.stringify(RetirementYear) + ', OfficeWise: ' + JSON.stringify(OfficeWise) + ', District: ' + JSON.stringify(District) + ', Designation: ' + JSON.stringify(Designation) + ''+
                        ' , EmployeeName: ' + JSON.stringify(EmployeeName) + ', EmployeeKey: ' + JSON.stringify(EmployeeKey) + ', JoiningYear: ' + JSON.stringify(JoiningYear) + ', IsVerified: ' + JSON.stringify(IsVerified) + '}',
                    ...
                    if (DistRecord != "") {
                        ...
                        $.each(DistRecord, function (ind, val) {
                            ...
                            if (getParameter("RG") != "") {
                                ...
                                if (GroupType == "JoiningYear") {
                                    var gheader = "<tr><td colspan=17 style='background-color: #f1f1f1;'><span style='font-weight:600; font-size:16px'> Joining Year : " + val[GroupType] + "</td></tr>"
                                    $('#tblRecord tbody').append(gheader);

                                    $('#lblgroupname').text("Group By : Joining Year");
                                }
                            ...
                            if (getParameter("RG") != "") {
                                var gfoot = "<tr><td colspan=" + (GroupType == "RetirementYear" || GroupType == "JoiningYear"  || GroupType == "OfficeType" ? 17 : 16) + " style='background-color: #f1f1f1;'><span style='font-weight:600; font-size:16px'> TOTAL " + (GroupType == "RetirementYear" || GroupType == "JoiningYear" ? val[GroupType] : val[GroupType].toUpperCase()) + " EMPLOYEE : " + count + "; <span class='text-success pl-2'> VERIFIED : " + ver_emp + ";<span><span class='text-danger pl-2'> NON-VERIFIED : " + nver_emp + "<span></td></tr>"
