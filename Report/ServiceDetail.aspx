<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ReportMaster.Master" AutoEventWireup="true" CodeBehind="ServiceDetail.aspx.cs" Inherits="HRISDashboard.Report.ServiceDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div style="clear: both; width: 100%;">
                ...
                <div style="width: 100%; float: left;">
                    ...
                    <div style="font-family: 'Calibri'; font-size: 16pt; float: left; width: 99%; text-align: center; color: #333; margin: 0px 5px 5px 5px;">
                        <strong>
                            <label id="lblHeading">Employee Service Detail (HRIS Dashboard)</label><br />
                            <span id="lblgroupname"></span></strong>
                    </div>
                </div>
                <div style="clear: both;">
                    <ul style="margin: 2px; list-style: none; background: #f1f1f1; border: 1px solid #000000">
                        <li style="display: inline-block; padding: 5px; font-size: 14px; font-weight: 600;"></li>
                        ...
                        <li style="display: inline-block; padding: 2px; font-size: 14px; width: 220px; padding-bottom: 2px;" class="f-right d-print-none">
                            ...
                            <table class="table table-striped table-bordered" id="tblRecord">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%; text-wrap: normal;" id="thOffice">ULB/Office Name</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thEmployeeName">Employee Name</th>
                                        <th style="width: 10%; text-wrap: normal;" id="thContactNo">Contact No</th>
                                        ...
                                        <th style="width: 10%; text-wrap: normal;" id="thTransactionType">Transaction Type</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thOrderNo">Order No.</th>
                                        <th style="width: 7%; text-wrap: normal;" id="thOrderDate">Order Date</th>
                                        <th style="width: 7%; text-wrap: normal;" id="thFromDate">From Date</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thFromState">From State</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thFromOffice">From Office</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thFromDesignatin">From Designation</th>
                                        <th style="width: 7%; text-wrap: normal;" id="thToDate">To Date</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thToState">To State</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thToOffice">To Office</th>
                                        <th style="width: 15%; text-wrap: normal;" id="thToDesignation">TO Designation</th>
                                    </tr>
                                </thead>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            GroupType = (GroupType == "" ? "EmployeeCode" : GroupType);
            ...
            $.ajax({
                type: "POST",
                url: "ServiceDetail.aspx/GetServiceDetail",
                data: '{RGroup:' + JSON.stringify(GroupType) + ',EmployeeType:' + JSON.stringify(EmployeeType) + ',OfficeType:' + JSON.stringify(OfficeType) + ',RetireYear:' + JSON.stringify(RetireYear) + ',OfficeWise:' + JSON.stringify(OfficeWise) + ',District:' + JSON.stringify(District) + ',IsVerified:' + JSON.stringify(IsVerified) + '}',
                ...
                success: function (r) {
                    ...
                    if (DistRecord != "") {
                        ...
                        $.each(DistRecord, function (ind, val) {
                            ...
                            if (getParameter("RG") != "" || GroupType != "") {

                                if (GroupType == "EmployeeCode") {
                                    //$('#thEmployeeCode').hide();
                                    //$('#thEmployeeName').hide();
                                    var gheader = "<tr><td colspan=20 style='background-color: #f1f1f1;'><span style='font-weight:600; font-size:16px'> Employee Name : " + val[GroupType].toUpperCase() + "-- " + val["EmployeeName"].toUpperCase() + "</td></tr>"
                            ...
                            $.each(arrFiler, function (i, v) {
                               ...
                               <%-- if (GroupType != "EmployeeCode") {
                                    row += "<td><a href='<%=ResolveUrl("~/Report/frmReport.aspx?EK=")%>" + v.EmployeeKey + "' target='_blank'>" + v.EmployeeCode + "</td>"
                                }--%>
                                 row += "<td><a href='<%=ResolveUrl("~/Report/EmployeeDetail.aspx?EK=")%>" + v.EmployeeCode + "' target='_blank'>" + v.EmployeeCode + "</td>"
                                ...
                                <%--if (GroupType != "EmployeeCode") {
                                    row += "<td><a href='<%=ResolveUrl("~/Report/frmReport.aspx?EK=")%>" + v.EmployeeKey + "' target='_blank'>" + v.EmployeeName + "</td>"
                                }--%>

                                row += "<td><a href='<%=ResolveUrl("~/Report/EmployeeDetail.aspx?EK=")%>" + v.EmployeeCode + "' target='_blank'>" + v.EmployeeName + "</td>"

                                row += "<td>" + v.ContactNo + "</td>"

                                row += "<td>" + v.DateOfJoin + "</td>"
                                //row += "<td>" + v.DateOfRetire + "</td>"
                                row += "<td>" + v.Transaction_Name + "</td>"

                                row += "<td>" + v.Order_No + "</td>"

                                row += "<td>" + v.orderdate + "</td>"
                                row += "<td>" + v.FromDate + "</td>"
                                row += "<td>" + v.From_State + "</td>"

                                row += "<td>" + v.frmoffice + "</td>"
                                row += "<td>" + v.frmdesig + "</td>"

                                row += "<td>" + v.ToDate + "</td>"
                                row += "<td>" + v.tostate + "</td>"

                                row += "<td>" + v.tooffice + "</td>"
                                row += "<td>" + v.todesig + "</td>"
                        ...
                        $.each(record, function (i, v) {
                            ...
                            row += "<td><a href='<%=ResolveUrl("~/Report/EmployeeDetail.aspx?EK=")%>" + v.EmployeeKey + "' target='_blank'>" + v.EmployeeCode + "</td>"
                            ...
                            row += "<td><a href='<%=ResolveUrl("~/Report/EmployeeDetail.aspx?EK=")%>" + v.EmployeeKey + "' target='_blank'>" + v.EmployeeName + "</td>"
                            row += "<td>" + v.ContactNo + "</td>"
                            row += "<td>" + v.DateOfJoin + "</td>"
                            //row += "<td>" + v.DateOfRetire + "</td>"
                            row += "<td>" + v.Transaction_Name + "</td>"
                        ...
                        //var gfoot = "<tr><td colspan=20 style='background-color: #f5f5f5;'><span style='font-weight:600; font-size:16px'> TOTAL EMPLOYEE : " + sr + "; <span class='text-success pl-2'> Verfied : " + ver_emp + ";<span><span class='text-danger pl-2'> Non-Verfied : " + nver_emp + "<span></td></tr>"
