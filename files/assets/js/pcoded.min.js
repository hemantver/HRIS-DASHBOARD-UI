    ...
    var PcodedMenu = {
        ...
        HandleThemeBackground: function() {
            ...
            function setheadertheme() {
                ...
                $('#' + oid + ' .pcoded-header').attr("header-theme", "theme3");
                //if (ev != undefined && ev != "") {
            ...
            function setlheadertheme() {
                ...
                $('#' + oid + ' .pcoded-header .navbar-logo').attr("logo-theme", "theme3");
                $('#' + oid + ' .pcoded-navigatio-lavel').attr("menu-title-theme", "theme3");
                //if (ev != undefined && ev != "") {
